...
echo "2. Em cada aba, rode respectivamente: ./start_orderer1.sh > raft_orderer1.log, ./start_orderer2.sh > raft_orderer2.log ./start_orderer3.sh > raft_orderer3.log, ./start_orderer4.sh > raft_orderer4.log"
